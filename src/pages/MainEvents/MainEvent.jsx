  ...
  return (
    <section className="container my-4">
        <div className="d-flex flex-column flex-lg-row gap-5 gap-lg-0 justify-content-center mx-4">
            <div className={ `${ style.roundedTopStart } border border-3 border-black border-end-0` }>
                ...
                <div className="d-flex flex-row ms-1 mb-1">
                    ...
                    <div className="ps-3 w-100 container">
                        ...
                        <div className="d-flex flex-row align-items-center gap-4 pt-3 border border-3 border-black border-end-0 border-start-0 pb-3">
