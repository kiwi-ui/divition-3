    ...
    return (
        <section className={ `${ style.bgCover } text-white overflow-hidden d-flex flex-column justify-content-between align-items-center text-center py-5` }>
            <div className={ `${ style.z10 }` }>
                ...
                <p className={ `mb-1 fw-bold ${ mainStyle.primary } `} style={{ letterSpacing: '0.2rem', fontSize: '2.4rem' }}>Yusni & Anggara</p>
            ...
            <div className={` ${ style.z10 } `}>
                ...
                <p className={`fs-1 fw-bold mb-3 ${ mainStyle.primary }`}>{ name }</p>
                <p>di tempat</p>
